...
class Conversation:
    def __init__(self, npc, location, topic, interrupt_speech):
        self.npc = npc
        self.location = location
        self.topic = topic
        self.interrupt_speech = interrupt_speech
        self.id = str(uuid4())
...
class NPCEngine:
    ...
    def conversation(self, json_data):
        ...
        interrupt_speech = json_data["interrupt_speech"]
        # 实例化Conversation
        convo = Conversation(npc, location, topic, interrupt_speech)
